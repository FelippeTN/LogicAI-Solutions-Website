    ...
    <div className="min-h-screen bg-background text-muted-foreground">
      ...
      <main className="container mx-auto px-4 py-20 md:py-28 max-w-4xl">
        <div className="text-center mb-6 md:mb-10">
          <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 md:mb-4">
        ...
        <div className="glass-card p-5 md:p-10 space-y-6 md:space-y-8">
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">1. Coleta de Informações</h2>
            <p className="text-sm md:text-base">Coletamos as seguintes informações quando você interage com nosso site:</p>
            <ul className="list-disc list-inside space-y-2 ml-2 md:ml-4 text-sm md:text-base">
              <li>
          ...
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">2. Uso das Informações</h2>
            <p className="text-sm md:text-base">As informações coletadas são usadas para os seguintes propósitos:</p>
            <ul className="list-disc list-inside space-y-2 ml-2 md:ml-4 text-sm md:text-base">
          ...
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">3. Proteção e Armazenamento</h2>
          ...
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">4. Compartilhamento de Informações</h2>
            <p className="text-sm md:text-base">
          ...
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">5. Seus Direitos</h2>
            <p className="text-sm md:text-base">Você tem o direito de:</p>
            <ul className="list-disc list-inside space-y-2 ml-2 md:ml-4 text-sm md:text-base">
            ...
            <p className="text-sm md:text-base">Para exercer qualquer um desses direitos, entre em contato conosco através do nosso formulário ou pelo WhatsApp.</p>
          </section>

          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">6. Contato</h2>
            <p className="text-sm md:text-base">
          ...
          <section className="space-y-2 md:space-y-3">
            <h2 className="font-display text-lg md:text-2xl font-semibold text-foreground">7. Alterações nesta Política de Privacidade</h2>
            <p className="text-sm md:text-base">
